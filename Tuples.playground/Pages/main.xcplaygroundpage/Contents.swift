 ...
 */
var person: (String, Int) = ("David", 39)
 ...
 */
var secondPerson: (String, Int) = ("Rachel", 42)

/*: question6
 ### 6. Print out "<Name> is <Age> years old" for the `someone` variable you created in Question 5.
 */
print("\(secondPerson.0) is \(secondPerson.1) years old.")
